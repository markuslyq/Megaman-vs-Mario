...
##Pmod Header JB
##Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports {JB_MIC3_Pin1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JB_MIC3_Pin1}]
###Sch name = JB2
##set_property PACKAGE_PIN A16 [get_ports {JB[1]}]					
#	#set_property IOSTANDARD LVCMOS33 [get_ports {JB[1]}]
###Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {JB_MIC3_Pin3}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JB_MIC3_Pin3}]
##Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {JB_MIC3_Pin4}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JB_MIC3_Pin4}]
##Sch name = JB7
